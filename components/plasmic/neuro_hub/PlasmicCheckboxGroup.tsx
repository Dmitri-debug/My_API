...
import Checkbox from "../../Checkbox"; // plasmic-import: esT9ojOIWyKZ/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: l9r7rTJlIlCx/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__eldpg)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ibz5U)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__fWzsA)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__c2RwZ)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
