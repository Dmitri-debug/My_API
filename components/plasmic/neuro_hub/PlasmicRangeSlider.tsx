...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: Csfrvpyadnzw/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__w7VxU)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox___1WgkG)}>
        <div
