...
import sty from "./PlasmicCaseStudiesWraper.module.css"; // plasmic-import: 7MKjb2iWEJdu/css
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img___28JxP)}
            displayHeight={"auto"}
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <Button
                className={classNames("__wab_instance", sty.button___97Ei1)}
                color={"blackCoffee"}
                submitsForm={true}
              >
                <div
