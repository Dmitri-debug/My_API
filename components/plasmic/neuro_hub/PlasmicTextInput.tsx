...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: k4OjPgSOZJNu/css
...
export type PlasmicTextInput__OverridesType = {
  deepInformationAnalysisAndKnowledgeExtraction?: Flex__<typeof BaseInput>;
};
...
function PlasmicTextInput__RenderFunc(props: {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      {
        path: "deepInformationAnalysisAndKnowledgeExtraction.value",
        type: "readonly",
        variableType: "text",
  ...
  return (() => {
    const child$Props = {
      ...
      className: classNames(
        ...
        sty.deepInformationAnalysisAndKnowledgeExtraction,
        {
          [sty.deepInformationAnalysisAndKnowledgeExtractionflat_bottom]:
            hasVariant($state, "flat", "bottom"),
          [sty.deepInformationAnalysisAndKnowledgeExtractionflat_left]:
            hasVariant($state, "flat", "left"),
          [sty.deepInformationAnalysisAndKnowledgeExtractionflat_right]:
            hasVariant($state, "flat", "right"),
          [sty.deepInformationAnalysisAndKnowledgeExtractionflat_top]:
            hasVariant($state, "flat", "top"),
          [sty.deepInformationAnalysisAndKnowledgeExtractionpadded_left]:
            hasVariant($state, "padded", "left"),
          [sty.deepInformationAnalysisAndKnowledgeExtractionpadded_right]:
            hasVariant($state, "padded", "right"),
          [sty.deepInformationAnalysisAndKnowledgeExtractiontype_plain]:
            hasVariant($state, "type", "plain"),
          [sty.deepInformationAnalysisAndKnowledgeExtractiontype_soft]:
      ...
      onChange: async (...eventArgs: any) => {
        generateStateOnChangePropForCodeComponents(
          $state,
          "value",
          ["deepInformationAnalysisAndKnowledgeExtraction", "value"],
          BaseInput_Helpers
      ...
      value: generateStateValueProp($state, [
        "deepInformationAnalysisAndKnowledgeExtraction",
        "value"
      ])
    };
    initializeCodeComponentStates(
    ...
    return (
      <BaseInput
        data-plasmic-name={"deepInformationAnalysisAndKnowledgeExtraction"}
        data-plasmic-override={
          overrides.deepInformationAnalysisAndKnowledgeExtraction
        }
...
type NodeDefaultElementType = {
  deepInformationAnalysisAndKnowledgeExtraction: typeof BaseInput;
};
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  if (nodeName === "deepInformationAnalysisAndKnowledgeExtraction") {
...
export const PlasmicTextInput = Object.assign(
  ...
  makeNodeComponent("deepInformationAnalysisAndKnowledgeExtraction"),
  {
