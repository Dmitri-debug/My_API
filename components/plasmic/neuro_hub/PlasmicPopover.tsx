...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: nlFHwLHB_4nz/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: Ctah-kxtmuNN/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__rmG58)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2__lWft3)}
            label={"Open Popover"}
          />
        ),
