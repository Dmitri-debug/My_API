...
import Label from "../../Label"; // plasmic-import: yUdlDGrBU3iR/component
import TextInput from "../../TextInput"; // plasmic-import: k4OjPgSOZJNu/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: FN4M6upg-c1s/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: UX1KA5U6pbF5/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__hxk5M, {
          [sty.freeBoxiconEnd__hxk5MXx9Et]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__hxk5MQujFu]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__hxk5M3Lwzt]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__b7L2, {
            [sty.freeBoxiconStart__b7L2QujFu]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__b7L23Lwzt]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__oDzaJ)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__q9F6W, {
            [sty.freeBoxiconEnd__q9F6Wxx9Et]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__q9F6WQujFu]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__hRaqy)}
                role={"img"}
              />
            ),
