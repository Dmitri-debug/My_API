...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: TFV4PI7xn5q6/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__niabX)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__cfJbm)}>
            <div
              className={classNames(
                projectcss.all,
