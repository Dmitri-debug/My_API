...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: xRJ0UekIgN2M/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__cyIiO)}>
        <div className={classNames(projectcss.all, sty.freeBox__ibyU4)} />
      </div>
      {renderPlasmicSlot({
