...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: esT9ojOIWyKZ/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: OkPOBw1DJFmz/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: J8ysMc-AzI6J/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__wYasp)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__kw8Vd)}
            role={"img"}
          />
        ) : null}
      </div>
