...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: NE2PuyeMzuEA/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__iuq5V)}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xykvl)}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__zaPmN)}
                displayHeight={"64px"}
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___2HpFi)}
              >
                <div className={classNames(projectcss.all, sty.freeBox__kp8Tt)}>
                  <h5
                    className={classNames(
                      projectcss.all,
                      projectcss.h5,
