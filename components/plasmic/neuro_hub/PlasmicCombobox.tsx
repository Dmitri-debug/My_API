...
import MenuPopover from "../../MenuPopover"; // plasmic-import: RaRgryjXtQCm/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: RIdj2d28rgSu/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__puUkv)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__iXMeJ)}>
            <ChevronDownIcon
