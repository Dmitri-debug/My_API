...
import sty from "./PlasmicServicesWhite.module.css"; // plasmic-import: Qk-ypPRu7uL9/css
...
function PlasmicServicesWhite__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___8D6Eh)}>
        {renderPlasmicSlot({
          defaultContents: (
            <Icon8Icon
              className={classNames(projectcss.all, sty.svg__hbmeh)}
              role={"img"}
            />
          ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xcXj2)}
      >
        <h3
